...
# ######################################################################################################################################################.H.S.##
# FILE:        changelog.org
#+TITLE:       FortranFinance changelog
#+AUTHOR:      Mitch Richling
#+EMAIL:       http://www.mitchr.me/
#+DESCRIPTION: Roadmap & TODO list for FortranFinance
#+KEYWORDS:    MRKISS
#+LANGUAGE:    en
...
:END:
  ...
  - API breaking Changes
    - Removed cashflow_*_pv_fv_print (functionality now in cashflow_*_pv_fv)
  - Deprecated functionality
    - N/A
  - New functionality
    - cashflow_*_pv_fv optional arguments provide cashflow_*_pv_fv_print functionality.
  - Documentation
    - N/A
  - Examples
    - New
  ...
  - Miscellaneous
    - setup.R
      - Included by all R code.  
      - Loads libraries
      - Configures image viewing.
    - setup.mk
      - Included by all makefiles
      - Sets up FF_PROJ_ROOT
      - Sets up "setup_fortran_gmake" and includes it
      - Contains instructions to manually configure the compiler without setup_fortran_gmake
      - Sets up MRFFL targets to make using MRFFL easy
    - Removed cmake stuff
    - Added 'eog' to image viewer list in R
    - Fixed for #2.  Thank you kreutpet!  Added library includes in R code.
    - Added make targets for image files in documentation

* v2025-09-24: Initial Release
:PROPERTIES:
