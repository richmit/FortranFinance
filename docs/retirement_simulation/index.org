...
# ######################################################################################################################################################.H.S.##
# FILE:        index.org
#+TITLE:       Fortran Finance: Retirement Simulation
...
:END:
   ...
   - ~final_savings.png~                       Histogram for final savings balance at death
   ...
   - ~y10_savings.png~                         Histogram of 10 year balance broken out by success & fail trajectories
   - ~composite_trajectories_y10.png~          Composite of *ALL* success trajectories zoomed in to the first 10 years
...
There is no universal measure of quality or fitness for these kinds of tools.  At the end of the day it's all about your situation and goals that determine if
a tool will help you or not. So, it is important that you do your research.
...
in doing the same kind of research.
 ...
 - Monte carlo deficiencies
   ...
   - GBM (Geometric Brownian Motion) models with dubious parameter values.
...
This first graph simply shows total savings balance by account type.
  ...
  [[file:pics/savings_by_type_20_fix.png][file:pics/savings_by_type_20_fix-pvue.png]]

This graph shows us paid vs unpaid expenses.  Expenses are broken into two categories (taxes & living expenses).

  [[file:pics/paid_and_unpaid_20_fix.png][file:pics/paid_and_unpaid_20_fix-pvue.png]]
...
before retirement.  This is what happens when salary doesn't keep up with inflation!
  ...
  [[file:pics/paid_by_source_20_fix.png][file:pics/paid_by_source_20_fix-pvue.png]]
...
the ~retire.R~ script.
  ...
  [[file:pics/savings_by_year_probability_bands_20_mc.png][file:pics/savings_by_year_probability_bands_20_mc-pvue.png]]
...
both people have died.
  ...
  [[file:pics/composite_trajectories_20_mc.png][file:pics/composite_trajectories_20_mc-pvue.png]]
...
This graph is similar to the probability band graph, but is a more traditional presentation for people accustomed to box plots.
  ...
  [[file:pics/savings_by_year_boxplot_20_mc.png][file:pics/savings_by_year_boxplot_20_mc-pvue.png]]
...
This graph shows us the ages at which simulations went broke, and how frequently it occurred for each age group.  Each bar spans three years.
  ...
  [[file:pics/probability_of_failure_by_year_20_mc.png][file:pics/probability_of_failure_by_year_20_mc-pvue.png]]

Lastly we have a graph that shows us the probability distribution of final savings balance at the end of the simulation.

  [[file:pics/final_savings_20_mc.png][file:pics/final_savings_20_mc-pvue.png]]
...
You can find this file in the GIT repository here: [[https://github.com/richmit/FortranFinance/blob/main/retirement_simulation/config_20.nml][=config_20.nml=]]
...
If you have make configured as described [[file:../MRFFL/index.html#examples][here]], then you can create all the images
in this section by entering the =retirement_simulation/= directory, and running make like this:
...
Things look just fine if we consider a simulation using ideal, fixed growth and inflation.  Here is what the overall savings balance looks:
  ...
  [[file:pics/savings_by_type_60o_fix.png][file:pics/savings_by_type_60o_fix-pvue.png]]

If we take a look at the savings probability bands, we see a very different picture:

  [[file:pics/savings_by_year_probability_bands_60o_mc.png][file:pics/savings_by_year_probability_bands_60o_mc-pvue.png]]

And if we look at a few paths and the account collapse cases, things look pretty scary:

  [[file:pics/composite_trajectories_60o_mc.png][file:pics/composite_trajectories_60o_mc-pvue.png]]
...
outcome from this plan.
  ...
  [[file:pics/final_savings_60o_mc.png][file:pics/final_savings_60o_mc-pvue.png]]
...
The new savings probability bands are much more positive:
  ...
  [[file:pics/savings_by_year_probability_bands_60ml_mc.png][file:pics/savings_by_year_probability_bands_60ml_mc-pvue.png]]

And the overall path picture is much more positive:

  [[file:pics/composite_trajectories_60ml_mc.png][file:pics/composite_trajectories_60ml_mc-pvue.png]]

Lastly, the distribution of final savings no longer shows dying broke as the highest probability outcome.

  [[file:pics/final_savings_60ml_mc.png][file:pics/final_savings_60ml_mc-pvue.png]]
...
You can find the configuration file in the GIT repository here: [[https://github.com/richmit/FortranFinance/blob/main/retirement_simulation/config_60.nml][=config_60.nml=]]

The configuration file for the origional plan:
...
#+begin_src f90 :eval never :tangle no :results none :exports code
...
#+BEGIN_SRC bash :exports both :results output verbatim
for f in pics/*.png; do 
  if [[ ! "$f" =~ '-pvue.png' ]]; then
    nf=${f/.png/-pvue.png}
    if [ $f -nt $nf ]; then
      echo "GEN: $f -> $nf"
      magick $f -resize 800x $nf
    else
      echo "NOP: $f -> $nf"
    fi
  fi
...
#+RESULTS:
#+begin_example
GEN: pics/composite_trajectories_20_mc.png -> pics/composite_trajectories_20_mc-pvue.png
GEN: pics/composite_trajectories_60ml_mc.png -> pics/composite_trajectories_60ml_mc-pvue.png
GEN: pics/composite_trajectories_60o_mc.png -> pics/composite_trajectories_60o_mc-pvue.png
GEN: pics/composite_trajectories_y10_20_mc.png -> pics/composite_trajectories_y10_20_mc-pvue.png
GEN: pics/composite_trajectories_y10_60ml_mc.png -> pics/composite_trajectories_y10_60ml_mc-pvue.png
GEN: pics/composite_trajectories_y10_60o_mc.png -> pics/composite_trajectories_y10_60o_mc-pvue.png
GEN: pics/death_distribution_20_mc.png -> pics/death_distribution_20_mc-pvue.png
GEN: pics/final_savings_20_mc.png -> pics/final_savings_20_mc-pvue.png
GEN: pics/final_savings_60ml_mc.png -> pics/final_savings_60ml_mc-pvue.png
GEN: pics/final_savings_60o_mc.png -> pics/final_savings_60o_mc-pvue.png
GEN: pics/paid_and_unpaid_20_fix.png -> pics/paid_and_unpaid_20_fix-pvue.png
GEN: pics/paid_and_unpaid_60o_fix.png -> pics/paid_and_unpaid_60o_fix-pvue.png
GEN: pics/paid_by_source_20_fix.png -> pics/paid_by_source_20_fix-pvue.png
GEN: pics/paid_by_source_60o_fix.png -> pics/paid_by_source_60o_fix-pvue.png
GEN: pics/probability_of_failure_by_year_20_mc.png -> pics/probability_of_failure_by_year_20_mc-pvue.png
GEN: pics/probability_of_failure_by_year_60ml_mc.png -> pics/probability_of_failure_by_year_60ml_mc-pvue.png
GEN: pics/probability_of_failure_by_year_60o_mc.png -> pics/probability_of_failure_by_year_60o_mc-pvue.png
GEN: pics/probability_of_success_by_year_20_mc.png -> pics/probability_of_success_by_year_20_mc-pvue.png
GEN: pics/probability_of_success_by_year_60ml_mc.png -> pics/probability_of_success_by_year_60ml_mc-pvue.png
GEN: pics/probability_of_success_by_year_60o_mc.png -> pics/probability_of_success_by_year_60o_mc-pvue.png
GEN: pics/savings_by_type_20_fix.png -> pics/savings_by_type_20_fix-pvue.png
GEN: pics/savings_by_type_60o_fix.png -> pics/savings_by_type_60o_fix-pvue.png
GEN: pics/savings_by_year_boxplot_20_mc.png -> pics/savings_by_year_boxplot_20_mc-pvue.png
GEN: pics/savings_by_year_boxplot_60ml_mc.png -> pics/savings_by_year_boxplot_60ml_mc-pvue.png
GEN: pics/savings_by_year_boxplot_60o_mc.png -> pics/savings_by_year_boxplot_60o_mc-pvue.png
GEN: pics/savings_by_year_probability_bands_20_mc.png -> pics/savings_by_year_probability_bands_20_mc-pvue.png
GEN: pics/savings_by_year_probability_bands_60ml_mc.png -> pics/savings_by_year_probability_bands_60ml_mc-pvue.png
GEN: pics/savings_by_year_probability_bands_60o_mc.png -> pics/savings_by_year_probability_bands_60o_mc-pvue.png
GEN: pics/y10_savings_20_mc.png -> pics/y10_savings_20_mc-pvue.png
GEN: pics/y10_savings_60ml_mc.png -> pics/y10_savings_60ml_mc-pvue.png
GEN: pics/y10_savings_60o_mc.png -> pics/y10_savings_60o_mc-pvue.png
#+end_example
