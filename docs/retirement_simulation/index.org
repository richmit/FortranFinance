...
:END:
  ...
  - Life Table
    - Add SSI Life tables module
      - Data access
      - probability computations on survival
      - Max age of person given sex and a percentile
      - max age of person given sex in table (same as above but 100% probability)
