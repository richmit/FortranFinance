...
:END:
  ...
  - Each partner will eventually draw Social Security
    ...
    - They each receive the same benefit level.
...
:END:
  ...
  - Support systems without STDOUT redirection: Make input file name argument required, and add optional output file name argument
  - Support different SSI benefit levels.
  - Add SSI life tables
...
expensive.  Some embarrassingly bad, and some quite sophisticated.  Still, I couldn't find everything I was looking for.

That's not to say this simulator has all the things I was looking for.  In fact, it doesn't have everything, and that's why I use it in combination with other
tools.  What I get from this simulator is additional insight into my particular scenario. At the end of the day it's all about your financial situation and
goals that determine if a tool will help you or not. So, it is important that you do your research.
